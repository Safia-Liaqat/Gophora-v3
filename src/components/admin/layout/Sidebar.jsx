...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#333333] text-white flex flex-col">
      {/* Header */}
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-2 rounded transition ${
                    isActiveSubItem(item.subItems)
                      ...
                      : 'hover:bg-[#FF4F00]/80 text-white hover:text-white'
                  }`}
                >
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          `block px-4 py-2 rounded text-sm transition ${
                            isActive
                              ? 'bg-[#FF4F00]/20 text-[#FF4F00] border-l-2 border-[#FF4F00]'
      ...
      {/* Footer */}
      <div className="p-4 border-t border-[#000000] text-sm text-white/70">
