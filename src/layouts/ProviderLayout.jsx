          ...
          <div className="border border-[#000000] rounded-md p-3 mb-3">
            ...
            {trustScore ? (
              <>
                ...
                <div className="h-[4px] bg-white/20 rounded-full overflow-hidden mb-2">
                  <div
                    className="h-full bg-[#FF4F00]"
                    style={{ width: `${trustScore}%` }}
                  />
                </div>
                <p className="text-[11px] text-white/50">Trust Score: {trustScore}/100</p>
              </>
            ) : (
              <p className="text-[12px] text-white/50">Not Verified</p>
            )}
          </div>
